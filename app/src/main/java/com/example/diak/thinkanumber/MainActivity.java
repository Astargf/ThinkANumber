...
public class MainActivity extends AppCompatActivity {
    ...
    private int kitalalando_szam = 0, tippelt_szam = 0 , hp = 6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alert_vesztett.setTitle("Vesztettél!")         //Cím adás
                .setMessage("Újra akarod kezdeni a játékot?")       //Kérdés amit felteszünk.
                .setPositiveButton("Nem", new DialogInterface.OnClickListener(){     //Pozitív gomb = jobb oldali gomb
                    @Override
                    public void onClick(DialogInterface dialog, int which){
        ...
        //BTN_PLUS ESEMÉNY ÍRÁS: ha rá klikkelünk akkor a tippelt_szam értékét növeljük.
